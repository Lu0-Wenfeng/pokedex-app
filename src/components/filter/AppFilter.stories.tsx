...
const FilterWrapper = ({
  ...
  return (
    <PokemonProvider>
      <div
        style={{ width: '100%', padding: '20px', backgroundColor: '#DEEDED' }}
      >
        ...
        >
          <strong>Note:</strong> This component requires Pokemon context. Filter
          actions will be logged to console.
        </div>
      </div>
    </PokemonProvider>
  );
...
export const Default: Story = {
  ...
  args: {
    isFilterEnable: (isEnable: boolean) =>
      console.log('Default filter enabled:', isEnable),
  },
  parameters: {
    docs: {
      description: {
        story:
          'Default filter component with search, type, and gender filters.',
      },
    },
  },
};
...
export const WithCallback: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Filter component with custom callback that shows alerts when filter state changes.',
      },
    },
  },
};
...
export const Interactive: Story = {
      ...
      <PokemonProvider>
        ...
        >
          ...
          >
            ...
            <br />
            <small>
              Try searching for Pokemon or selecting types/genders to see the
              status change.
            </small>
          </div>
        </div>
  ...
  args: {
    isFilterEnable: (isEnable: boolean) =>
      console.log('Interactive callback:', isEnable),
  },
  parameters: {
    docs: {
      description: {
        story:
          'Interactive filter component that shows real-time filter status changes.',
      },
    },
  },
};
...
export const FullWidth: Story = {
  render: args => (
    <div
      style={{ width: '100vw', backgroundColor: '#DEEDED', minHeight: '200px' }}
    >
      <FilterWrapper {...args} />
    </div>
  ),
  args: {
    isFilterEnable: (isEnable: boolean) =>
      console.log('Full width filter enabled:', isEnable),
  },
  parameters: {
    layout: 'fullscreen',
    docs: {
  ...
  render: () => (
    <PokemonProvider>
      ...
      >
        ...
        >
          <strong>Warning:</strong> No callback provided - filter actions will
          have no effect.
        </div>
      </div>
    </PokemonProvider>
