...
const FilterWrapper = ({ isFilterEnable, ...props }: { isFilterEnable?: (isEnable: boolean) => void }) => {
  ...
  return (
    <PokemonProvider>
      <div style={{ width: "100%", padding: "20px", backgroundColor: "#DEEDED" }}>
        ...
        >
          <strong>Note:</strong> This component requires Pokemon context. Filter actions will be logged to console.
        </div>
      </div>
    </PokemonProvider>
  );
      ...
      <PokemonProvider>
        <div style={{ width: "100%", padding: "20px", backgroundColor: "#DEEDED" }}>
          ...
          >
            ...
            <br />
            <small>Try searching for Pokemon or selecting types/genders to see the status change.</small>
          </div>
        </div>
      </PokemonProvider>
    );
...
export const FullWidth: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: "Filter component displayed at full viewport width, as it appears in the main application.",
      },
    },
  },
};
...
export const WithoutCallback: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Filter component with empty callback function - useful for testing UI without side effects.",
      },
    },
  },
};
