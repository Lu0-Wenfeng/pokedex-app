...
export const Default: Story = {
  ...
  args: {
    ...
    onChangeHandler: (value, _event) => console.log('Default selection:', value),
  },
};
...
export const PokemonTypes: Story = {
  ...
  args: {
    ...
    label: 'Type',
    placeholder: 'Select Types',
    onChangeHandler: (value, _event) => console.log('Pokemon types selected:', value),
  },
  parameters: {
    docs: {
      description: {
        story: 'Dropdown configured for Pokemon type selection with all 18 Pokemon types.',
      },
    },
  },
};
...
export const PokemonGenders: Story = {
  ...
  args: {
    ...
    onChangeHandler: (value, _event) => console.log('Pokemon genders selected:', value),
  },
  parameters: {
    docs: {
      description: {
...
export const WithoutLabel: Story = {
  ...
  args: {
    ...
    onChangeHandler: (value, _event) => console.log('No label selection:', value),
  },
  parameters: {
    docs: {
      description: {
...
export const SmallDataset: Story = {
  ...
  args: {
    ...
    onChangeHandler: (value, _event) => console.log('Small dataset selection:', value),
  },
  parameters: {
    docs: {
      description: {
...
export const LargeDataset: Story = {
  ...
  args: {
    ...
    onChangeHandler: (value, _event) => console.log('Large dataset selection:', value),
  },
  parameters: {
    docs: {
      description: {
        story: 'Dropdown with a large dataset of 50 options to test performance and scrolling.',
      },
    },
  },
};
...
export const CustomPlaceholder: Story = {
  ...
  args: {
    ...
    onChangeHandler: (value, _event) => console.log('Custom placeholder selection:', value),
  },
  parameters: {
    docs: {
      description: {
...
export const MinimalTest: Story = {
  render: () => {
    console.log('🔄 MinimalTest story rendering...');

    return (
      <div style={{ padding: '40px' }}>
        <h3>Minimal Test - Direct CheckPicker</h3>
        <CheckPicker
          data={[
            { label: 'A', value: 'a' },
            { label: 'B', value: 'b' },
          ...
          onOpen={() => {
            console.log('🟢 DIRECT CheckPicker onOpen fired!');
            alert('Direct onOpen works!');
          }}
          onClose={() => {
            console.log('🔴 DIRECT CheckPicker onClose fired!');
            alert('Direct onClose works!');
          }}
          onChange={(value) => {
            console.log('🔄 DIRECT CheckPicker onChange:', value);
          }}
          style={{ width: 200 }}
          placeholder="Test direct callbacks"
        />
      </div>
    );
  },
...
export const WithCustomClass: Story = {
  ...
  args: {
    ...
    onChangeHandler: (value, _event) => console.log('Custom class selection:', value),
  },
  parameters: {
    docs: {
      description: {
