...
export const WithoutLabel: Story = {
  ...
  args: {
    ...
    onChangeHandler: (value, _event) => console.log('Search without label:', value),
  },
};
...
export const LongLabel: Story = {
  ...
  args: {
    ...
    onChangeHandler: (value, _event) => console.log('Long label search:', value),
  },
};
...
export const EmptyPlaceholder: Story = {
  ...
  args: {
    label: 'Search',
    onChangeHandler: (value, _event) => console.log('Empty placeholder search:', value),
  },
};
