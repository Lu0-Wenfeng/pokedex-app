...
export const PokemonAppHeader: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Header as used in the Pokemon app with title, separator line, and description.',
      },
    },
  },
};
  ...
  args: {
    children: (
      ...
      >
        ...
        <div style={{ fontSize: '16px', color: '#333' }}>Gotta catch &apos;em all!</div>
      </div>
    ),
  },
  parameters: {
...
export const WithCustomClass: Story = {
  args: {
    ...
    children: (
      ...
      >
        <h3 style={{ margin: 0, color: '#2E3156' }}>Header with Custom Class</h3>
