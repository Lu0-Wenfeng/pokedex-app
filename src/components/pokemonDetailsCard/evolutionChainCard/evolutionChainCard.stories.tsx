...
export const FullWidth: Story = {
  render: (args) => (
    ...
    >
      ...
      >
        <strong>Note:</strong> This component currently shows placeholder evolution stages. In a
        real implementation, this would display actual evolution chain data from the Pokemon API.
      </div>
    </div>
  ),
  args: {
