...
const meta: Meta<typeof StatCard> = {
  ...
  argTypes: {
    stats: {
      description: 'Array of Pokemon stat objects containing base stat values and names',
      control: { type: 'object' },
    },
  },
};
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Default stat card showing Bulbasaur's balanced starter Pokemon stats.",
      },
    },
  },
};
...
export const Charizard: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Stat card showing Charizard's high offensive stats, particularly Special Attack.",
      },
    },
  },
};
...
export const Pikachu: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Stat card showing Pikachu's speed-focused stat distribution with low HP.",
      },
    },
  },
};
...
export const BalancedStats: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Stat card showing perfectly balanced stats at 80 for all categories.',
      },
    },
  },
};
...
export const SingleStat: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Stat card showing only a single stat (HP) for testing minimal data.',
      },
    },
  },
};
...
export const StatComparison: Story = {
  render: () => (
    <div style={{ padding: '20px', backgroundColor: '#DEEDED' }}>
      <h4 style={{ marginBottom: '20px', textAlign: 'center' }}>Pokemon Stat Comparison</h4>
      ...
      >
        <div>
          <h5 style={{ marginBottom: '10px', textAlign: 'center' }}>Bulbasaur (Starter)</h5>
          <StatCard stats={bulbasaurStats} />
        </div>

        <div>
          <h5 style={{ marginBottom: '10px', textAlign: 'center' }}>Charizard (Evolved)</h5>
          <StatCard stats={charizardStats} />
        </div>

        <div>
          <h5 style={{ marginBottom: '10px', textAlign: 'center' }}>Pikachu (Speed Focus)</h5>
          <StatCard stats={pikachuStats} />
        </div>

        <div>
          <h5 style={{ marginBottom: '10px', textAlign: 'center' }}>Legendary Pokemon</h5>
...
export const StatTypes: Story = {
  render: () => (
    <div style={{ padding: '20px', backgroundColor: '#DEEDED' }}>
      <h4 style={{ marginBottom: '20px', textAlign: 'center' }}>Stat Type Examples</h4>
      ...
      <div style={{ marginBottom: '30px' }}>
        <h5 style={{ marginBottom: '10px' }}>Glass Cannon (High Attack, Low Defense)</h5>
        <StatCard
          stats={[
      ...
      <div>
        <h5 style={{ marginBottom: '10px' }}>Support (Balanced with High Special Defense)</h5>
        <StatCard
          stats={[
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Examples of different Pokemon archetypes showing extreme stat distributions.',
      },
    },
  },
};
...
export const ProgressBarTest: Story = {
  render: () => (
    <div style={{ padding: '20px', backgroundColor: '#DEEDED' }}>
      <h4 style={{ marginBottom: '20px', textAlign: 'center' }}>Progress Bar Visualization Test</h4>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Test of progress bar visualization at different stat value ranges.',
      },
    },
  },
};
