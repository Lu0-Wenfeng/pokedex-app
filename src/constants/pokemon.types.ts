// Pokemon type definitions and utility functions
...
export type PokemonTypeName = keyof typeof POKEMON_TYPE;
...
export const getPokemonDescription = (data: FlavorTextEntry[] = []): string => {
  if (data.length) {
