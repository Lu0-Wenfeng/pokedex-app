import { PokemonState, PokemonAction, PokemonReducer } from "../../types/context.types";
...
export const reducer: PokemonReducer = (state: PokemonState, action: PokemonAction): PokemonState => {
    switch (action.type) {
